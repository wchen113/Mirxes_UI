                                    ...
                                    <div className="live-preview">
                                        <Row>
                                            ...
                                            <Col xl={6}>
                                                ...
                                                <h6>Dark Alert</h6>
                                                <Alert color="dark" className='border-0'>
                                                    <strong>Did you know?</strong> A simple <b>dark alert</b> —check it out!
                                                </Alert>
                                    ...
                                    <div className="live-preview">
                                        <Row>
                                            <Col xl={6}>
                                                ...
                                                <UncontrolledAlert color="danger" className="alert alert-danger alert-dismissible border-2 bg-body-secondary fade show mb-xl-0">
                                            ...
                                            <Col xl={6}>
                                                ...
                                                <UncontrolledAlert color="warning" className="alert alert-warning alert-dismissible border-2 bg-body-secondary fade show">
                                                    <strong> Uh oh, something went wrong! </strong> - Outline <b>warning alert</b> example
                                                </UncontrolledAlert>

                                                <h6>Info Outline Alert</h6>
                                                <UncontrolledAlert color="info" className="alert alert-info alert-dismissible border-2 bg-body-secondary fade show">
                                                    <strong>Don't forget' it !</strong> - Outline <b>info alert</b> example
                                                </UncontrolledAlert>

                                                <h6>Dark Alert</h6>
                                                <UncontrolledAlert color="dark" className="alert alert-warning alert-dismissible border-2 bg-body-secondary fade show mb-0">
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use the <code>bg-*, border-* & text-white </code> class to set an alert with solid style.</p>
