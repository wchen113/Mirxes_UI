                    ...
                    <Row>
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use the <code>rounded-pill bg-*-subtle text-*</code> class to make badges more rounded
                                        with a larger border-radius.</p>

                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap gap-2">
                                            <Badge className='rounded-pill bg-primary-subtle text-primary'> Primary </Badge>
                                            <Badge className='rounded-pill bg-secondary-subtle text-secondary'> Secondary </Badge>
                                            <Badge className='rounded-pill bg-success-subtle text-success'> Success </Badge>
                                            <Badge className='rounded-pill bg-info-subtle text-info'> Info </Badge>
                                            <Badge className='rounded-pill bg-warning-subtle text-warning'> Warning </Badge>
                                            <Badge className='rounded-pill bg-danger-subtle text-danger'> Danger </Badge>
                                            <Badge className='rounded-pill bg-dark-subtle text-body'> Dark </Badge>
                                            <Badge className='rounded-pill bg-light-subtle text-body text-primary'> Light </Badge>
                                        </div>
                                    </div>
                                    <div className="d-none code-view">
                                        <pre className="language-markup" style={{ height: "200px" }}>
