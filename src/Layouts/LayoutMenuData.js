...
const Navdata = () => {
    ...
    const [isDemandForecastChartClicked, setIsDemandForecastChartClicked] = useState(false);
    ...
    const menuItems = [
        ...
        {
            id: "disruption",
            label: "Disruption Monitoring New",
            icon: "ri-tornado-fill",
            link: "/portdisruptioninfonew",
            click: function (e) {
                e.preventDefault();
                setIscurrentState('');
            }
               ...
               {
            id: "disruption",
            label: "Disruption Monitoring",
            icon: "ri-tornado-fill",
            link: "/portdisruptioninfo",
            click: function (e) {
                e.preventDefault();
                setIscurrentState('');
            }
               ...
               {
            id: "disruption",
            label: "Disruption Monitoring Streamlit",
            icon: "ri-tornado-fill",
            link: "/portdisruptioninfostreamlit",
            click: function (e) {
                e.preventDefault();
                setIscurrentState('');
            }
        ...
        //     subItems: [
        //         {
        //             id: "demandForecastChart",
        //             label: "Demand Forecast Chart",
        //             icon: "ri-pie-chart-line",
        //             link: "/DemandPlanner/DemandForecasting/charts",
        ...
        //             icon: "ri-pie-chart-line",
        //             link: "/DemandPlanner/DemandForecasting/ForecastCharts",
        ...
        //     label: "CKL Dashboard",
        //     icon: "ri-layout-5-fill",
        //     link: "/DemandPlanner/DemandForecasting/CKL",
        //     click: function (e) {
        //         e.preventDefault();
        ...
        //     label: "CKL Forecast",
        //     icon: "ri-layout-5-fill",
        //     link: "/DemandPlanner/DemandForecasting/CKLForecast",
        //     click: function (e) {
        //         e.preventDefault();
        //         setIscurrentState('Widgets');
        //     }
        ...
        // {
        //     id: "uploadfile",
        //     label: "New Products Forecast",
        //     icon: "ri-image-2-fill",
        //     link: "/DemandPlanner/DemandForecasting/ImageUpload",
        //     click: function (e) {
        //         e.preventDefault();
        ...
        //     icon: "ri-image-2-fill",
        //     link: "/DemandPlanner/DemandForecasting/DataEngineering",
        //     click: function (e) {
        //         e.preventDefault();
